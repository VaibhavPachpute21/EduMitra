                    ...
                    <div className="container py-4 py-xl-5">
                        ...
                        <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                          ...
                          <div className="col-xxl-3">
                                <Link to={`/Project/fdsfdsf`} className="text-decoration-none text-black">
                                    <div style={{ borderRadius: '5px', padding: '5px', background: 'var(--bs-body-bg)', boxShadow: '0px 0px 5px 2px var(--bs-dark-border-subtle)' }}>
                                        <img className="rounded img-fluid d-block w-100 fit-cover" style={{ height: '200px' }} src={'https://img.freepik.com/premium-vector/man-character_665280-46969.jpg'} alt="Project" />
                                        <div className="py-4">
